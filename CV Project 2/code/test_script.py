...
adv_dataset = AdvCIFAR10Dataset(root='../adv_images/PGD_nodefense', transform=transforms.Compose([
...
def test(model,test_loader):
    ...
    atk = torchattacks2.PGD(model, mean=0.5, std=0.5, eps=6/255., alpha=2/255., steps=12)
    ...
    for images, labels in test_loader:
        ...
        #    torchvision.utils.save_image(normalized_aimgs[i], ROOT+"/adv_images/PGD_nodefense/" + str(counter) + "_" + str(labels[i].item()) + ".png", normalize=False)
        #    counter = counter + 1
