...
class IPGD(Attack):
    ...
    """
    def __init__(self, model, mean, std, eps=0.3, alpha=2/255, steps=40, random_start=False):
        super(IPGD, self).__init__("IPGD", model)
    ...
    def forward(self, images, labels):
        ...
        images2 = torch.nn.functional.interpolate(images2, scale_factor=2, mode='nearest')
        ...
        delta2 = images2-adv_images
        adv_images = images+delta2
        return adv_images
